...
; r12 będzie służył do zliczania długosci maksymalnego niepustego ciągu bajtów niezawierającego bajtu,
; którego wartość jest kodem ASCII litery s lub S,zerujemy gdy trafimy na s lub S.
...
buffer2     resb 1536                    ; Rezerwacja 1536 bajtów (odpowiednio dużo: 3/2*buffer1).
